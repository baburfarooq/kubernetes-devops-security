    ...
    stage('Vulnerability Scan - Docker') {
      ...
      parallel (
        "Dependency Scan":{
          ...
          "OPA Conftest" : {
            sh 'docker run --rm -v /var/lib/jenkins/workspace/devsecops-numeric-application:/project openpolicyagent/conftest test --policy opa-docker-security.rego myrepo/first:latest'
          }
        )
      }
    }
